            ...
            if (sankeyDataSet && sankeyDataSet.nodes && sankeyDataSet.links && sankeyDataSet.depthNodes) {
                ...
                var tipLink = d3.tip()
                    ...
                    .html(function (d) {
                        ...
                        if (isOutNode(d.target.name)) {
                            ...
                            return makeToolTip(piwik.helper.htmlEntities(piwik.helper.escape(d.source.name)) + ": <span class='nodeTooltipExits'>" + message + "</span>");
                        }

                        var from = '"' + piwik.helper.htmlEntities(piwik.helper.escape(d.source.name)) + '"';
                        var to = '"' + piwik.helper.htmlEntities(piwik.helper.escape(d.target.name)) + '"';
                ...
                var tip = d3.tip()
                    ...
                    .html(function (d) {
                        ...
                        return makeToolTip(piwik.helper.htmlEntities(piwik.helper.escape(d.name))
