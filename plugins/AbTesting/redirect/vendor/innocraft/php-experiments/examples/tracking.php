<?php
/**
 * This is mainly useful for users of A/B Testing for Matomo (www.ab-tests.net). It shows you how to send
 * a tracking request form your server to your Matomo letting it know that you just activated a variation
 * for a user.
 */
...
// gives you a JavaScript tracking snippet that you can print in your HTML website to let Matomo know
