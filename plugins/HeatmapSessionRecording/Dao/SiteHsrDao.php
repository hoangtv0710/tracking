...
class SiteHsrDao
{
    ...
    public function getRecords($idSite, $recordType)
    {
        ...
        $records = $this->getDb()->fetchAll($sql, array($recordType, self::STATUS_ENDED, self::STATUS_ACTIVE, $idSite));
    ...
    public function getRecord($idSite, $idSiteHsr, $recordType)
    {
        ...
        $record = $this->getDb()->fetchRow($sql, array($recordType, self::STATUS_ENDED, self::STATUS_ACTIVE, $idSite, $idSiteHsr));
    ...
    public function getNumRecordsTotal($recordType)
    {
        ...
        return $this->getDb()->fetchOne($sql, array($recordType, self::STATUS_ENDED, self::STATUS_ACTIVE));
    }
