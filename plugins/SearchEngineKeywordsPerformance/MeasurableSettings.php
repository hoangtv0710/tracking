...
class MeasurableSettings extends \Piwik\Settings\Measurable\MeasurableSettings
{
    ...
    protected function configureGoogleSettings()
    {
        ...
        if (!SearchEngineKeywordsPerformance::isGoogleForceEnabled($this->idSite) &&
            (!$this->hasMeasurableType(WebsiteMeasurableType::ID) || !$googleClient->isConfigured())
        ) {
            return;
        }
    ...
    protected function configureBingSettings()
    {
        ...
        if (!SearchEngineKeywordsPerformance::isBingForceEnabled($this->idSite) &&
            (!$this->hasMeasurableType(WebsiteMeasurableType::ID) || !$bingClient->isConfigured())
        ) {
            return;
        }
