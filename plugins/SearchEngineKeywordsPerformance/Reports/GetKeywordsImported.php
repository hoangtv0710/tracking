...
class GetKeywordsImported extends Base
{
    protected function init()
    {
        ...
        $this->subcategoryId = null; // hide report
    }
    ...
    {
        return [
            ReportsProvider::factory('SearchEngineKeywordsPerformance', 'getKeywords'),
            ReportsProvider::factory('Referrers', 'getKeywords'),
        ];
    }
