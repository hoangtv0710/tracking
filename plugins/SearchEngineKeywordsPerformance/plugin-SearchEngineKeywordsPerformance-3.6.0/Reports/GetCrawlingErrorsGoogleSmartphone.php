...
class GetCrawlingErrorsGoogleSmartphone extends Base
{
    ...
    public function configureView(ViewDataTable $view)
    {
        ...
        $this->configureReportDiscontinued($view);
    ...
    public function isEnabled()
    {
        ...
        if ($settings->disableGoogleCrawlReports->getValue()) {
            return false;
        }
        ...
        return !empty($setting->googleSearchConsoleUrl) && strpos($setting->googleSearchConsoleUrl->getValue(), '##sc-set:') === false && strpos($setting->googleSearchConsoleUrl->getValue(), '##sc-domain:') === false;
    }
}
