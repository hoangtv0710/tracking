<?php return array (
  ...
  array (
    ...
    array (
      ...
      'API' => 'API',
      'Apply' => 'Apply',
      'ArchivingInlineHelp' => 'For medium to high traffic websites, it is recommended to disable Hub-JS archiving to trigger from the browser. Instead, we recommend that you setup a cron job to process Hub-JS reports every hour.',
      'ArchivingTriggerDescription' => 'Recommended for larger Hub-JS installs, you need to %1$ssetup a cron job%2$s to process the reports automatically.',
      ...
      'ConfigFileIsNotWritable' => 'The Hub-JS configuration file %1$s is not writable, some of your changes might not be saved. %2$s Please change permissions of the config file to make it writable.',
      'Continue' => 'Continue',
      'ContinueToPiwik' => 'Continue to Matomo',
      'CurrentlyUsingUnsecureHttp' => 'You are currently using Hub-JS over unsecure HTTP. This can make your Hub-JS vulnerable to security exploits. You may also be in breach of privacy laws, as some features including opt-out cookies will not work. We recommend you set up Hub-JS to use SSL (HTTPS) for improved security.',
      ...
      'Error' => 'Error',
      'Errors' => 'Errors',
      'ErrorRequest' => 'Oops… there was a problem during the request. Maybe the server had a temporary issue, or maybe you requested a report with too much data. Please try again. If this error occurs repeatedly please %1$scontact your Hub-JS administrator%2$s for assistance.',
      'EvolutionOverPeriod' => 'Evolution over the period',
      'EvolutionSummaryGeneric' => '%1$s in %2$s compared to %3$s in %4$s. Evolution: %5$s',
      'ExceptionContactSupportGeneric' => 'If you still have this issue please %1$scontact your Hub-JS administrator%2$s for assistance. ',
      ...
      'ExceptionConfigurationFileExistsButNotReadable' => 'The config file %s seems to exist but Hub-JS could not read it.',
      'ExceptionConfigurationFilePleaseCheckReadableByUser' => 'Please check that %1$s is readable by the user \'%2$s\'.',
      'ExceptionDatabaseVersion' => 'Your %1$s version is %2$s but Hub-JS requires at least %3$s.',
      'ExceptionDatabaseVersionNewerThanCodebase' => 'Your Hub-JS codebase is running the old version %1$s and we have detected that your Hub-JS Database has already been upgraded to the newer version %2$s.',
      'ExceptionDatabaseVersionNewerThanCodebaseWait' => 'Maybe your Hub-JS administrators are currently finishing the upgrade process. Please try again in a few minutes.',
      ...
      'FileIntegrityWarningReupload' => 'Errors below may be due to a partial or failed upload of Hub-JS files.',
      'FileIntegrityWarningReuploadBis' => 'Try to reupload all the Hub-JS files in BINARY mode.',
      'First' => 'First',
      'Flatten' => 'Flatten',
      'ForcedSSL' => 'Forced SSL Connection',
      'ForceSSLRecommended' => 'We recommend using Hub-JS over secure SSL connections only. To prevent insecure access over http, add %1$s to the %2$s section in your Hub-JS config/config.ini.php file.',
      'NotPossibleWithoutHttps' => 'Attention: Doing this without having set up a SSL certificate for using HTTPS will break Matomo.',
      'UseSSLInstall' => 'We recommend using Hub-JS over secure SSL connections only. Please %1$sclick here continue the installation process over SSL%2$s.',
      'ForExampleShort' => 'eg.',
      'Forums' => 'Forums',
      'FromReferrer' => 'from',
      'Generic' => 'Generic',
      ...
      'HelpTranslatePiwik' => 'Maybe you would like to %1$shelp us improve the Hub-JS translations%2$s?',
      'Hide' => 'hide',
      ...
      'Never' => 'Never',
      'New' => 'New',
      'NewReportsWillBeProcessedByCron' => 'When Hub-JS archiving is not triggered by the browser, new reports will be processed by the crontab.',
      'NewUpdatePiwikX' => 'New Update: Hub-JS %s',
      ...
      'SmtpFromEmailHelp' => 'The default value is noreply@{DOMAIN}, where {DOMAIN} will be replaced with your Hub-JS domain "%1$s".<br>If sending mails doesn\'t work for you, you might need to set this address to match your SMTP username.',
      ...
      'Print' => 'Print',
      'Profiles' => 'Profiles',
      'MatomoIsACollaborativeProjectYouCanContributeAndDonateNextRelease' => '%1$sMatomo%2$s, formerly known as Piwik, is a collaborative project brought to you by the %7$sHub-JS team%8$s members as well as many other contributors around the globe. <br/> If you\'re a fan of Matomo, you can help: find out %3$sHow to participate in Matomo%4$s, or %5$sdonate now%6$s to help fund the next great Hub-JS release!',
      'PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%1$s is available. Please notify the %2$sHub-JS administrator%3$s.',
      'PiwikXIsAvailablePleaseUpdateNow' => 'Hub-JS %1$s is available. %2$sPlease update now!%3$s (see %4$schanges%5$s).',
      'PleaseContactYourPiwikAdministrator' => 'Please contact your Hub-JS administrator.',
      ...
      'Source' => 'Source',
      'StatisticsAreNotRecorded' => 'Hub-JS Visitor Tracking is currently disabled! Re-enable tracking by setting record_statistics = 1 in your config/config.ini.php file.',
      'Subtotal' => 'Subtotal',
      'Summary' => 'Summary',
      'Table' => 'Table',
      'TagCloud' => 'Tag Cloud',
      ...
      'WarningPiwikWillStopSupportingPHPVersion' => 'Hub-JS will stop supporting PHP %1$s in the next major version. Upgrade your PHP to at least PHP %2$s, before it\'s too late!',
      'YouMustUpgradePhpVersionToReceiveLatestPiwik' => 'You must upgrade your PHP version in order to receive the latest Hub-JS update.',
      'PiwikCannotBeUpgradedBecausePhpIsTooOld' => 'Hub-JS cannot be upgraded to the latest major version because your PHP version is too old.',
      'PleaseUpgradeYourPhpVersionSoYourPiwikDataStaysSecure' => 'Please upgrade your PHP version to at least PHP %s so your Hub-JS analytics data stays secure.',
      ...
      'WarningFileIntegrityNoManifestDeployingFromGit' => 'If you are deploying Hub-JS from Git, this message is normal.',
      ...
      'Yes' => 'Yes',
      'YouAreCurrentlyUsing' => 'You are currently using Hub-JS %s.',
    ...
    'Mobile' => 
    array (
      'AboutPiwikMobile' => 'About Hub-JS Mobile',
      'AccessUrlLabel' => 'Hub-JS Access Url',
      'Account' => 'Account',
      'Accounts' => 'Accounts',
      'AddAccount' => 'Add account',
      'AddPiwikDemo' => 'Add Hub-JS Demo',
      'Advanced' => 'Advanced',
      'AnonymousAccess' => 'Anonymous access',
      'AnonymousTracking' => 'Anonymous tracking',
      'AskForAnonymousTrackingPermission' => 'When enabled, Hub-JS Mobile will send anonymous usage data to matomo.org. The intent is to use this data to help Hub-JS Mobile developers better understand how the app is used. Information sent is: menus and settings clicked on, OS name and version, any error displayed in Hub-JS Mobile. We will NOT track any of your analytics data. This anonymous data will never be made public. You can disable/enable anonymous tracking in Settings at any time.',
      ...
      'HelpUsToImprovePiwikMobile' => 'Would you like to enable anonymous usage tracking in Hub-JS Mobile?',
      ...
      'HttpIsNotSecureWarning' => 'Your Hub-JS authorization token (token_auth) is sent in clear text if you use \'HTTP\'. For this reason we recommend HTTPS for secure transport of data over the internet. Do you want to proceed?',
      'HttpTimeout' => 'HTTP Timeout',
      'IncompatiblePiwikVersion' => 'The Hub-JS version you are using is incompatible with Hub-JS Mobile 2. Update your Hub-JS installation and try again or install Hub-JS Mobile 1.',
      'LastUpdated' => 'Last Updated: %s',
      'LoadingReport' => 'Loading %s',
      'LoginCredentials' => 'Credentials',
      'LoginToPiwikToChangeSettings' => 'Login to your Hub-JS server to create and update websites, users or to change General Settings like "Report to load by default".',
      'LoginUseHttps' => 'Use https',
      'MatomoMobile' => 'Hub-JS Mobile App',
      ...
      'NoDataShort' => 'No Data',
      'NoPiwikAccount' => 'No Hub-JS Account?',
      ...
      'RatingPleaseRateUs' => 'Hub-JS Mobile App is a Free Software, we would really appreciate if you took 1 minute to rate the app in the %1$s. If you have suggestions of new features or bug reports, please contact %2$s',
      'ReleaseToRefresh' => 'Release to refresh...',
      'Reloading' => 'Reloading...',
      'RequestTimedOutShort' => 'Network Timeout Error',
      'RestrictedCompatibility' => 'Restricted compatibility',
      'RestrictedCompatibilityExplanation' => 'The Hub-JS version %s you are using is not fully supported by Hub-JS Mobile 2. You may experience some bugs. We recommend to either update Hub-JS to the latest version or to use Hub-JS Mobile 1.',
      'SaveSuccessError' => 'Hub-JS URL or username and password combination is wrong.',
      ...
      'MatomoMarketplace' => 'Hub-JS Marketplace',
