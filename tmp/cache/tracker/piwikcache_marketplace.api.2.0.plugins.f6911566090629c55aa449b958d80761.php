  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2021-01-21 21:23:08',
...
<p>This plugin is built and maintained by the creators of Matomo.</p>',
            ...
            'download' => '/api/2.0/plugins/MediaAnalytics/download/3.4.14',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
        ...
        array (
          'license' => 
          array (
            'startDate' => '2021-01-12 07:50:37',
            'endDate' => '2022-01-12 07:50:37',
            'nextPaymentDate' => '2022-01-12 07:50:37',
            'status' => 'Active',
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2021-01-21 01:40:23',
...
<p>To learn more about the plugin, have a look at the <a href="https://www.form-analytics.net">Form Analytics website</a>, <a href="https://matomo.org/docs/form-analytics">Form Analytics User Guide</a>, <a href="https://matomo.org/faq/form-analytics">Form Analytics FAQ</a> and the <a href="https://developer.matomo.org/guides/form-analytics">developer documentation</a>.</p>',
            ...
            'download' => '/api/2.0/plugins/FormAnalytics/download/3.1.28',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
...
<p>We are the creators of Matomo and know it better than anyone else. This means all plugins are perfectly integrated into Matomo and come with outstanding features and quality to grow your business. We help our clients get started, configure, monitor and make the most of their Matomo analytics service. We also offer unique analytics products and services that help grow your business and meet the needs of small, medium and large businesses alike.</p>',
            ...
            'download' => '/api/2.0/plugins/WhiteLabel/download/3.3.11',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2021-01-15 14:28:26',
        'latestVersion' => '3.6.0',
        'numDownloads' => NULL,
        'screenshots' => 
        array (
...
<li>Export your Keyword analytics report using the <a href="http://developer.matomo.org/api-reference/reporting-api#SearchEngineKeywordsPerformance">Search Keywords Performance Monitor API</a>. </li>
            ...
            'download' => '/api/2.0/plugins/SearchEngineKeywordsPerformance/download/3.6.0',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2021-01-04 01:25:55',
        'latestVersion' => '3.0.7',
        'numDownloads' => NULL,
        'screenshots' => 
        array (
...
<p>To learn more about the plugin, have a look at the <a href="https://matomo.org/docs/multi-channel-conversion-attribution">Multi Attribution User Guide</a> and the <a href="https://matomo.org/faq/multi-channel-conversion-attribution">Multi Attribution FAQ</a>.</p>',
            ...
            'download' => '/api/2.0/plugins/MultiChannelConversionAttribution/download/3.0.7',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2020-12-18 01:00:14',
...
<p>If you enable the logging of all tracking requests to a file, you will find the logs under <code>wp-content/uploads/wc-logs/woo-piwik-tracking-yyyy-dd-mm-*.log</code>.</p>',
            ...
            'download' => '/api/2.0/plugins/WooCommerceAnalytics/download/3.0.15',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2020-12-17 00:41:30',
...
The <a href="https://developer.matomo.org/guides/ab-tests">A/B Testing developer guides</a> help you embedding and implementing A/B tests into your project.</p>',
            ...
            'download' => '/api/2.0/plugins/AbTesting/download/3.2.18',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2020-12-09 03:02:27',
...
<p>To learn more about the plugin have a look at the <a href="https://matomo.org/docs/cohorts/">Cohorts Analysis User Guide</a>.</p>',
            ...
            'download' => '/api/2.0/plugins/Cohorts/download/3.0.11',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2020-12-03 03:26:55',
...
<p>To learn more about the plugin, have a look at the <a href="https://www.heatmap-analytics.com">Heatmap &amp; Session Recording website</a>, <a href="https://matomo.org/docs/heatmaps">Heatmap User Guide</a>, <a href="https://matomo.org/docs/session-recording/">Session Recording User Guide</a>, <a href="https://matomo.org/faq/heatmap-session-recording/">Heatmap &amp; Session Recording FAQ</a> and the <a href="https://developer.matomo.org/guides/heatmap-session-recording">developer documentation</a>.</p>',
            ...
            'download' => '/api/2.0/plugins/HeatmapSessionRecording/download/3.2.39',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2020-11-30 01:08:06',
...
<p>For any other question feel free to <a href="#support">contact us</a>.</p>',
            ...
            'download' => '/api/2.0/plugins/Funnels/download/3.1.22',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2020-11-26 20:27:20',
...
<p>This plugin is built and maintained by the creators of Matomo.</p>',
            ...
            'download' => '/api/2.0/plugins/CustomReports/download/3.1.27',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2020-11-18 21:37:45',
...
<p>For any other question feel free to <a href="#support">contact us</a>.</p>',
            ...
            'download' => '/api/2.0/plugins/UsersFlow/download/3.1.12',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2020-11-08 20:03:41',
        'latestVersion' => '3.2.7',
        'numDownloads' => NULL,
        'screenshots' => 
        array (
...
<p>For any other question feel free to <a href="#support">contact us</a>.</p>',
            ...
            'download' => '/api/2.0/plugins/RollUpReporting/download/3.2.7',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
...
<p>We are the creators of Matomo and know it best. We help our clients get started, configure, monitor and make the most of their Matomo analytics service. We also offer unique analytics products and services that help grow your business and meet the needs of small, medium and large businesses alike.</p>',
            ...
            'download' => '/api/2.0/plugins/LoginSaml/download/3.3.2',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
...
<a href="/api-reference/reporting-api#ActivityLog">Activity Log HTTP Reporting API</a>.</p>',
            ...
            'download' => '/api/2.0/plugins/ActivityLog/download/3.4.0',
          ),
        ),
        'isDownloadable' => true,
        'changelog' => 
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2020-08-24 01:39:19',
        'latestVersion' => '3.0.9',
        'numDownloads' => NULL,
        'screenshots' => 
        array (
          0 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/0_Premium_Bundle.jpg',
          1 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/1_Click_Heatmap.jpg',
          2 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/2_Session_Recording_Player.png',
          3 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/2_Session_Recording_Move_And_Click_Path.jpg',
          4 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/3_Manage_A_B_Tests.png',
          5 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/3_AB_Testing.png',
          6 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/4_Funnels.png',
          7 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/5_Custom_Reports.png',
          8 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/5_Users_Flow.png',
          9 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/5_Users_Flow_Interaction_Menu.png',
          10 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/7_Crawling_Errors.png',
          11 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/7_Keywords_on_Google_Search_Clicks_-_Impressions_-_Clickthrough_-_Position_in_results_page.png',
          12 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/8_Form_Analytics_By_Page_URL.png',
          13 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/8_Form_Analytics_Drop_Off_Fields.png',
          14 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/8_Form_Analytics_Evolution.png',
          15 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/9_Roll-Up_Reporting.jpg',
          16 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/9_Media_Analytics_Overview.png',
          17 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/9_Media_Analytics_Real-time_Reports.png',
          18 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/10_Activity_Log.jpg',
          19 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/11_WooCommerce_Log.png',
          20 => 'https://plugins.matomo.org/PremiumBundle/images/3.0.9/11_WooCommerce_Integration.png',
        ),
        'previews' => 
        array (
        ),
...
<p>We are the creators of Matomo and know it better than anyone else. This means all plugins are perfectly integrated into Matomo and come with outstanding features and quality to grow your business. We help our clients get started, configure, monitor and make the most of their Matomo analytics service. We also offer unique analytics products and services that help grow your business and meet the needs of medium and large businesses alike.</p>',
      ...
      array (
        ...
        'repositoryUrl' => NULL,
        'lastUpdated' => '2020-08-24 01:37:50',
        'latestVersion' => '3.0.8',
        'numDownloads' => NULL,
        'screenshots' => 
        array (
          0 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/0_Grow_Business.jpg',
          1 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/1_Click_Heatmap.jpg',
          2 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/2_Session_Recording_Move_And_Click_Path.jpg',
          3 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/2_Session_Recording_Player.png',
          4 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/3_AB_Testing.png',
          5 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/3_Manage_A_B_Tests.png',
          6 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/4_Funnels.png',
          7 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/5_Users_Flow.png',
          8 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/5_Users_Flow_Interaction_Menu.png',
          9 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/6_Media_Analytics_Overview.png',
          10 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/6_Media_Analytics_Real-time_Reports.png',
          11 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/7_Crawling_Errors.png',
          12 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/7_Keywords_on_Google_Search_Clicks_-_Impressions_-_Clickthrough_-_Position_in_results_page.png',
          13 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/8_Form_Analytics_By_Page_URL.png',
          14 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/8_Form_Analytics_Drop_Off_Fields.png',
          15 => 'https://plugins.matomo.org/GrowthBundle/images/3.0.8/8_Form_Analytics_Evolution.png',
        ),
        'previews' => 
        array (
        ),
